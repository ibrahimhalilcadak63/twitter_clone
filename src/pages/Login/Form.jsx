      ...
      <>
        <form onSubmit={handleSubmit} className="flex flex-col">
          ...
          <input
            type="text"
            required
            className="text-black rounded mt-1 p-2 outline-none shadow-lg focus:shadow-[#e35353]"
          ...
          <button className="mt-10 bg-white text-black rounded-full p-1 font-bold transition hover:bg-[#e35353]">
